        ...
        <div style={contentStyle}>
          ...
          <div style={sectionStyle}>
            <div style={{ marginBottom: "2rem" }}>
              ...
              <p style={termContentStyle}>
                ...
                ทั้งนี้ Timelab Photobooth
                เป็นผู้ควบคุมข้อมูลส่วนบุคคล (Data Controller)
              ...
              <p style={termContentStyle}>
                ...
                ซึ่งรวมถึงการถ่ายภาพบุคคลหรือภาพกลุ่ม การเลือกธีม กรอบ
                ฟิลเตอร์ หรือองค์ประกอบตกแต่งภาพ
              ...
              <br />
              <p style={termContentStyle}>
                <strong>"เหตุสุดวิสัย"</strong> หมายถึง
                เหตุการณ์หรือสถานการณ์ใด ๆ
                ที่อยู่นอกเหนือการควบคุมของผู้ให้บริการหรือผู้ใช้บริการ
            ...
            <div style={{ marginBottom: "2rem" }}>
              ...
              <p style={termContentStyle}>
                ...
                ผู้ใช้บริการตกลงว่าจะไม่ใช้บริการเพื่อกระทําการใด ๆ
                ที่ผิดกฎหมาย ฝ่าฝืนข้อกําหนดและเงื่อนไขนี้
                ขัดต่อศีลธรรมอันดี
              ...
              <p style={termContentStyle}>
                ...
                ทั้งนี้ ผู้ใช้บริการไม่มีสิทธิเรียกร้องค่าเสียหาย
                หรือค่าชดเชยใด ๆ จากผู้ให้บริการ
              </p>
            </div>
            ...
            <div style={{ marginBottom: "2rem" }}>
              ...
              <p style={termContentStyle}>
                ...
                ไม่เหมาะสม
                หรืออาจก่อให้เกิดความเสียหายต่อผู้ให้บริการ บุคคลอื่น
            ...
            <div style={{ marginBottom: "2rem" }}>
              ...
              <p style={termContentStyle}>
                ...
                หรือการกระทําใด ๆ
                ที่อาจเป็นการละเมิดกฎหมายทรัพย์สินทางปัญญา
              </p>
              <br />
              <p style={termContentStyle}>
                ผู้ใช้บริการตกลงและรับทราบว่าผู้ให้บริการเป็นเจ้าของสิทธิในการดําเนินกิจการ
                อุปกรณ์ เทคโนโลยี เนื้อหา
                และสื่อที่ใช้ในตู้ถ่ายรูป Timelab Photobooth ทั้งหมด
                การใช้บริการไม่ถือเป็นการโอนสิทธิใด ๆ ให้แก่ผู้ใช้บริการ
                ผู้ใช้บริการต้องไม่ใช้บริการเพื่อสร้างหรือเผยแพร่เนื้อหาที่ผิดกฎหมาย
                ลามกอนาจาร ก่อให้เกิดความเกลียดชัง
            ...
            <div style={{ marginBottom: "2rem" }}>
              ...
              <p style={termContentStyle}>
                ผู้ให้บริการขอสงวนสิทธิ์ในการปรับปรุง แก้ไข เปลี่ยนแปลง
                อัปเดต ระงับ หรือยุติการให้บริการทั้งหมดหรือบางส่วนได้ทุกเมื่อ
                โดยไม่จําเป็นต้องแจ้งให้ผู้ใช้บริการทราบล่วงหน้า
                ซึ่งรวมถึงระบบจัดเก็บรูปภาพ ระบบดาวน์โหลด
                ฟีเจอร์ต่าง ๆ ภายในตู้ถ่ายรูป และอัตราค่าบริการ
              </p>
              <br />
              <p style={termContentStyle}>
                ผู้ใช้บริการรับทราบและตกลงว่าผู้ให้บริการจะไม่รับผิดชอบต่อความสูญเสีย
                ความเสียหาย
                หรือความไม่สะดวกใด ๆ
            ...
            <div style={{ marginBottom: "2rem" }}>
              ...
              <ul style={listStyle}>
                <li style={listItemStyle}>
                  ใช้บริการเพื่อถ่ายภาพหรือเผยแพร่เนื้อหาที่ผิดกฎหมาย
                  ลามกอนาจาร รุนแรง เหยียดหยาม สร้างความเกลียดชัง
                  หรือคุกคามผู้อื่น
                </li>
                <li style={listItemStyle}>
                  กระทําการที่ละเมิดลิขสิทธิ์ สิทธิในภาพบุคคล
                  ความเป็นส่วนตัว
            ...
            <div style={{ marginBottom: "2rem" }}>
              ...
              <p style={termContentStyle}>
                Timelab Photobooth
                ในฐานะผู้ประกอบการและผู้ควบคุมข้อมูลส่วนบุคคล (Data Controller)
                ตามพระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคล พ.ศ. 2562 (PDPA)
                เป็นผู้รับผิดชอบแต่เพียงผู้เดียวในการเก็บรวบรวม ใช้
              ...
              <p style={termContentStyle}>
                ...
                รับผิดชอบแต่เพียงผู้เดียวในการดูแลรักษาความปลอดภัย
                ความสมบูรณ์
                และการจัดการข้อมูลภาพถ่ายดังกล่าวตามมาตรฐานที่กฎหมาย PDPA
                กําหนด
              </p>
              <br />
              <p style={termContentStyle}>
                ...
                <br />
                ภาพถ่ายจะถูกเก็บรักษาไว้เพื่อวัตถุประสงค์ในการให้บริการ
                ได้แก่ การพิมพ์ภาพ การดาวน์โหลด
                และการส่งภาพให้ผู้ใช้บริการ Timelab Photobooth
                จะไม่นําภาพถ่ายไปใช้เพื่อวัตถุประสงค์อื่นใด
              ...
              <p style={termContentStyle}>
                ...
                <br />
                ผู้ใช้บริการมีสิทธิตามกฎหมาย PDPA
                ในการขอเข้าถึง แก้ไข ลบ
              ...
              <p style={termContentStyle}>
                ...
                <br />
                Timelab Photobooth
                รับผิดชอบต่อการรั่วไหล สูญหาย
                หรือการเข้าถึงข้อมูลภาพถ่ายโดยไม่ได้รับอนุญาต
                อันเกิดจากการดําเนินงานของ Timelab Photobooth
            ...
            <div style={{ marginBottom: "2rem" }}>
              ...
              <p style={termContentStyle}>
                ...
                โดยวิธีการชําระเงินสามารถทําได้ผ่านช่องทางที่ Timelab
                Photobooth กําหนด อาทิ QR Code, บัตรเครดิต, เดบิต
            ...
            <div style={{ marginBottom: "2rem" }}>
              ...
              <p style={termContentStyle}>
                ...
                <br />
                ข้อกําหนดและเงื่อนไขนี้ไม่ได้สร้างความสัมพันธ์แบบหุ้นส่วน
                ตัวแทน หรือความร่วมทุนใด ๆ
          ...
          >
            <p style={{ color: theme?.fontColor || "#e5e7eb", opacity: 0.9 }}>
              ...
              โปรดติดต่อ Timelab Photobooth ได้โดยตรง
            </p>
          </div>
